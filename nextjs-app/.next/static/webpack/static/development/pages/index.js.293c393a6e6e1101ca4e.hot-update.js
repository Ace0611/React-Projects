...
class Prices extends react__WEBPACK_IMPORTED_MODULE_1___default.a.Component {
  ...
  render() {
    ...
    if (this.state.currency === 'USD') {} else if (this.state.currency === 'GBP') {} else if (this.state.currency === '') return __jsx("div", {
      __source: {
...
//# sourceMappingURL=index.js.293c393a6e6e1101ca4e.hot-update.js.map