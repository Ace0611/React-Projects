...
class Prices extends react__WEBPACK_IMPORTED_MODULE_1___default.a.Component {
  ...
  render() {
    ...
    if (this.state.currency === 'USD') {} else if (this.state.currency === 'GBP') {} else if (this.state.currenct) return __jsx("div", {
      __source: {
...
//# sourceMappingURL=index.js.4ccbd8f41c7ecc2507d2.hot-update.js.map