...
class Prices extends react__WEBPACK_IMPORTED_MODULE_1___default.a.Component {
  ...
  render() {
    ...
    if (this.state.currency === 'USD') {} else if (this.state.currency === 'GBP') {} else if (this.state.currency === 'EUR') return __jsx("div", {
      __source: {
...
//# sourceMappingURL=index.js.a7b59729a5e684189271.hot-update.js.map